			...
			<td>
				<table width="70%" cellspacing="0" cellpadding="0" border="1"
					...
					<tr>
						...
						<td height="35" class="td_default" align="left">&nbsp;&nbsp;<input
							class="input_default" type="text" id="mpost" value="${memberDTO.post}" readonly></input></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td height="35" class="td_default" align="left">&nbsp;&nbsp;<input
							class="input_default" type="text" id="mphone" value="${memberDTO.phone}" readonly></input>
