	...
	$(document).ready(function(){
		...
		$("#find").on("click",function(event){
			if($("#username").val().length==0){
				...
				location.href="PasswordSearchFormServlet?username="+$("#username").val()+"&email="+$("#email").val();
			}
		});
...
<span style="font-size:12px; color:red;"><b>아이디를 입력해주세요</b></span></br>
...
<a href="PasswordSearchServlet">아이디 찾기</a>
</body>
</html>