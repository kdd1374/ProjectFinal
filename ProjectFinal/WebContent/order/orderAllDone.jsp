...
<c:set var="username" value="${xxx[0].username}" />
...
<c:set var="email1" value="${xxx[0].email1}" />
<c:set var="email2" value="${xxx[0].email2}" />
		...
		<td>
			<table width="750px" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<td class="td_default" height="35">${username}</td>
				</tr>
				<tr>
