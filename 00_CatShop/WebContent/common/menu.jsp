...
<span style="font-size:12px;"><a href="CartListServlet" id="login">장바구니</a></span><br>
...
<span style="font-size:12px;">
<a href="LogOutServlet">로그아웃</a></span><br>
<span style="font-size:12px;"><a href="CartListServlet" id="login">장바구니</a></span>&nbsp;&nbsp;
<span style="font-size:12px;">마이페이지</span>
<%} %>
<%} %>
</div>
...
<span style="font-size:12px;"><a href="LoginServlet" id="login">
공지사항</a></span><br>
<span style="font-size:12px;"><a href="MemberSignupServlet">1:1문의</a></span><br>
</div>
</div>
<div id="wrap-right">
